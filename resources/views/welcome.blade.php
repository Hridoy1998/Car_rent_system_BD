    ...
    <div class="relative pt-32 pb-40 lg:pt-48 lg:pb-48 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-3 px-6 py-2 rounded-2xl bg-white/5 border border-white/10 mb-10 overflow-hidden group">
                ...
                <span class="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] group-hover:text-white transition-colors duration-500">Premium Fleet Active in Sector</span>
            </div>
            ...
            <p class="max-w-2xl mx-auto text-sm md:text-base text-gray-400 mb-16 font-medium tracking-wide leading-relaxed">
                Connect with the most exclusive peer-to-peer car sharing network in Bangladesh. <br class="hidden whitespace-pre md:block"/> Transparent auditing, professional assets, and frictionless deployment.
            </p>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-20 px-4 gap-6 text-center md:text-left">
                <div>
                    <div class="flex items-center justify-center md:justify-start gap-3 mb-4">
                        ...
                        <span class="text-[10px] font-black text-indigo-400 uppercase tracking-[0.4em]">Curated Selection</span>
                    </div>
                    <h2 class="text-4xl md:text-5xl font-black text-white italic tracking-tighter">ELITE ASSETS</h2>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-gray-900/30 backdrop-blur-xl rounded-[3rem] overflow-hidden border border-white/5 hover:border-indigo-500/20 transition-all duration-700 hover:shadow-[0_40px_80px_rgba(0,0,0,0.5)] flex flex-col relative">
                    <a href="{{ route('cars.show', $car) }}" class="relative aspect-[16/10] overflow-hidden bg-gray-950 block">
                        <img src="{{ $car->primary_image_url }}" class="w-full h-full object-cover transition-all duration-1000 group-hover:scale-110">
                        ...
                        @if(!$car->is_available)
                            <div class="absolute inset-0 bg-gray-950/70 backdrop-blur-sm flex items-center justify-center z-10">
                                <span class="px-8 py-3 bg-red-600 text-white text-[10px] font-black uppercase tracking-[0.4em] rounded-2xl shadow-2xl rotate-[-4deg]">DEPLOYED</span>
                            </div>
                        @endif
                    </a>
                    ...
                    <div class="p-8 flex-1 flex flex-col justify-between">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-white/5">
                            <div class="flex items-center gap-3 group/owner">
                                <div class="w-10 h-10 rounded-2xl bg-gray-800 border border-white/10 flex items-center justify-center overflow-hidden shadow-2xl group-hover/owner:border-indigo-500/50 transition-all">
                                ...
                                <a href="{{ route('profiles.show', $car->owner) }}" class="text-[10px] font-black text-gray-500 hover:text-white transition-colors uppercase tracking-[0.2em] italic">{{ $car->owner->name }}</a>
                            </div>
                ...
                @empty
                    <div class="col-span-full group py-32 bg-gray-900/20 rounded-[3rem] border border-white/5 border-dashed flex flex-col items-center justify-center">
                        ...
                        <div class="text-[11px] text-gray-700 font-black uppercase tracking-[0.5em] italic">Scanning Global Fleet Cache...</div>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-12">
                <div class="text-center group">
                    ...
                    <div class="text-[10px] font-black text-gray-600 uppercase tracking-widest">Asset Uptime</div>
                </div>
                <div class="text-center group">
                    ...
                    <div class="text-[10px] font-black text-gray-600 uppercase tracking-widest">Verified Nodes</div>
                </div>
                <div class="text-center group">
                    ...
                    <div class="text-[10px] font-black text-gray-600 uppercase tracking-widest">Auth Latency</div>
                </div>
                <div class="text-center group">
                    ...
                    <div class="text-[10px] font-black text-gray-600 uppercase tracking-widest">Active Signal</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-32 bg-gray-950 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-24">
                <div class="inline-block px-5 py-2 bg-indigo-600/10 border border-indigo-500/20 rounded-full text-[10px] font-black text-indigo-400 uppercase tracking-[0.4em] mb-6 italic">Seamless Deployment</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="bg-white/[0.02] p-10 rounded-[3rem] border border-white/5 hover:border-indigo-500/20 transition-all duration-700">
                    ...
                    <h3 class="text-xl font-black text-white mb-4 uppercase tracking-widest italic">Pick Your Asset</h3>
                    <p class="text-[13px] text-gray-500 font-medium leading-relaxed tracking-wide">Browse our elite collection. Filter by your exact performance and style requirements.</p>
                </div>
                <div class="bg-white/[0.02] p-10 rounded-[3rem] border border-white/5 hover:border-purple-500/20 transition-all duration-700">
                    ...
                    <h3 class="text-xl font-black text-white mb-4 uppercase tracking-widest italic">Instant Booking</h3>
                    <p class="text-[13px] text-gray-500 font-medium leading-relaxed tracking-wide">Authorize your dates and complete the payment through our secure transaction nodes.</p>
                </div>
                <div class="bg-white/[0.02] p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all duration-700">
                    ...
                    <h3 class="text-xl font-black text-white mb-4 uppercase tracking-widest italic">Hit The Road</h3>
                    <p class="text-[13px] text-gray-500 font-medium leading-relaxed tracking-wide">Coordinate with the owner, inspect your asset, and start your premium journey.</p>
                </div>
            </div>
            ...
            <div class="mt-24 text-center">
                <a href="{{ route('register') }}" class="group relative inline-flex items-center gap-4 px-16 py-8 bg-white text-gray-950 font-black rounded-[2.5rem] hover:bg-gray-200 transition-all duration-500 overflow-hidden">
                    <span class="relative z-10 text-xs uppercase tracking-[0.3em] italic">Join NEON MONOLITH</span>
